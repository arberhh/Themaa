      ...
      <header class="masthead">
        <div class="container header">
          <div class="intro-text">
            ...
            <a class="btn btn-primary btn-xl text-uppercase" href="membership-account/membership-levels/">Subscribe!</a>
            <a class="btn btn-primary btn-xl text-uppercase" href="wp-login.php">&nbsp;&nbsp;&nbsp;Log  in! &nbsp;&nbsp;&nbsp;&nbsp;</a>
          </div>
        </div>
      </header>